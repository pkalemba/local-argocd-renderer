...
func main() {
	...
	var repoRoot = flag.String("repo-root", ".", "Root of the checkout that source paths are resolved against")
	...
	var capabilitiesFile = flag.String("capabilities", "", "Path to a YAML file with the destination cluster's kubeVersion and apiVersions, used by the .Capabilities checks in Helm charts")
	...
	if (*applicationFile == "") == (*applicationDir == "") {
		...
		fmt.Fprintf(os.Stderr, "  %s --app app.yaml --capabilities capabilities.yaml\n", os.Args[0])
